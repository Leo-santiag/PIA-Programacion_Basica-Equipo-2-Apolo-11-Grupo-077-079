import requests
import re
#Existe un documento llamando Pruebas.py en el cual se hace la importacion de este modulo y el modulo PokeGet que son parte de la programacion modular del primer script 
